...
const SearchBar = () => {
  ...
  return (
    <div className="bg-[#F5F5F3] md:py-6 py-3">
      <Container className="relative flex justify-between gap-3 md:gap-0 px-3 md:px-0">
        ...
        {show && (
          <ul className="catddm absolute top-full left-0 bg-slate-200 w-[263px]">
            <Li
            ...
            >
              <div  className={`static md:absolute md:group-hover:flex md:gap-12 gap-5 md:text-[16px] text-[12px] left-full top-0 bg-white h-full text-nowrap md:hidden md:px-10 px-2 py-0 md:py-8 flex-wrap md:flex-nowrap  ${accesories ? "flex" : 'hidden'}`}>

                
                <ul className="flex flex-col md:gap-3 gap-1 text-nowrap">
                  <h3 className="md:mb-3 mb-0 font-DM font-bold text-[16px]">Phones</h3>
            ...
            hover:pl-[31px] hover:left-3 md:px-4 px-2 md:py-5 py-3"
              liText="Furniture"
            >
              <div className={`static md:absolute md:group-hover:flex md:gap-12 gap-5 md:text-[16px] text-[12px] left-full top-0 bg-white h-full text-nowrap md:hidden md:px-10 px-2 py-0 md:py-8 flex-wrap md:flex-nowrap  ${furniture ? "flex" : 'hidden'}`}>
            ...
            hover:pl-[31px] hover:left-3 md:px-4 px-2  md:py-5 py-3"
              liText="Electronics"
            >
              <div className={`static md:absolute md:group-hover:flex md:gap-12 gap-5 md:text-[16px] text-[12px] left-full top-0 bg-white h-full text-nowrap md:hidden md:px-10 px-2 py-0 md:py-8 flex-wrap md:flex-nowrap  ${electronics ? "flex" : 'hidden'}`}>
            ...
            hover:pl-[31px] hover:left-3 md:px-4 px-2 md:py-5 py-3"
              liText="Clothes"
            >
              <div className={`static md:absolute md:group-hover:flex md:gap-12 gap-5 md:text-[16px] text-[12px] left-full top-0 bg-white h-full text-nowrap md:hidden md:px-10 px-2 py-0 md:py-8 flex-wrap md:flex-nowrap  ${clothes ? "flex" : 'hidden'}`}>
            ...
            hover:pl-[31px] hover:left-3 md:px-4 px-2  md:py-5 py-3"
              liText="Bags"
            >
              <div className={`static md:absolute md:group-hover:flex md:gap-12 gap-5 md:text-[16px] text-[12px] left-full top-0 bg-white h-full text-nowrap md:hidden md:px-10 px-2 py-0 md:py-8 flex-wrap md:flex-nowrap  ${bags ? "flex" : 'hidden'}`}>
            ...
            >
              <div className={`static md:absolute md:group-hover:flex md:gap-12 gap-5 md:text-[16px] text-[12px] left-full top-0 bg-white h-full text-nowrap md:hidden md:px-10 px-2 py-0 md:py-8 flex-wrap md:flex-nowrap  ${home ? "flex" : 'hidden'}`}>
        ...
        <div  className="account md:flex hidden items-center gap-x-10">
          <div onClick={()=> setLogin(!login)} className="left flex items-center gap-x-2.5">
            <FaUser />
            <TiArrowSortedDown />
          </div>
        ...
        
     {
      login &&(
        ...
        <Button className='!w-full bg-[#2B2B2B] text-Primary' ButtonText='My Account'/>
